          ...
          <div className="grid grid-cols-1 gap-4">
            ...
            <div className="bg-card/50 p-5 rounded-[32px] border border-white/10 shadow-xl backdrop-blur-md relative overflow-hidden group">
              ...
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  <h3 className="font-black uppercase tracking-widest text-sm text-gradient-silver">Nível Classic</h3>
                  <p className="text-[9px] font-bold text-muted-foreground uppercase tracking-widest">0 - 99 Pontos</p>
                </div>
              </div>
              <p className="text-xs text-muted-foreground leading-relaxed mb-4">O alicerce da Arena: Tradição e manutenção impecável do seu estilo (Prata Metálico).</p>
              <div className="space-y-2">
                <div className="flex items-center gap-2 text-[10px] font-black text-foreground/80">
                  <CheckCircle size={10} className="text-gradient-silver" /> Manutenção do visual com excelência
                </div>
                <div className="flex items-center gap-2 text-[10px] font-black text-foreground/80">
                  <CheckCircle size={10} className="text-gradient-silver" /> Agendamento simplificado via App
                </div>
              </div>
            </div>
            ...
            <div className="bg-card/50 p-5 rounded-[32px] border border-white/10 shadow-xl backdrop-blur-md relative overflow-hidden group">
              ...
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  <h3 className="font-black uppercase tracking-widest text-sm text-gradient-bronze">Nível Select</h3>
                  <p className="text-[9px] font-bold text-muted-foreground uppercase tracking-widest">100 - 299 Pontos</p>
                </div>
              </div>
              <p className="text-xs text-muted-foreground leading-relaxed mb-4">Conveniência e agilidade: Prioridade na agenda e lugar cativo na Arena (Bronze Metálico).</p>
              <div className="space-y-2">
                <div className="flex items-center gap-2 text-[10px] font-black text-foreground/80">
                  <CheckCircle size={10} className="text-gradient-bronze" /> Flexibilidade extra em horários
                </div>
                <div className="flex items-center gap-2 text-[10px] font-black text-foreground/80">
                  <CheckCircle size={10} className="text-gradient-bronze" /> Atendimento prioritário no Lounge
                </div>
              </div>
            </div>
            ...
            <div className="bg-card/50 p-5 rounded-[32px] border border-white/10 shadow-xl backdrop-blur-md relative overflow-hidden group">
              ...
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  <h3 className="font-black uppercase tracking-widest text-sm text-gradient-gold">Nível Privilege</h3>
                  <p className="text-[9px] font-bold text-muted-foreground uppercase tracking-widest">300 - 499 Pontos</p>
                </div>
              </div>
              <p className="text-xs text-muted-foreground leading-relaxed mb-4">Um novo patamar de regalias: Descontos em produtos premium e atendimento elite (Ouro Metálico).</p>
              <div className="space-y-2">
                <div className="flex items-center gap-2 text-[10px] font-black text-foreground/80">
                  <CheckCircle size={10} className="text-gradient-gold" /> 10% OFF em produtos de cuidado pessoal
                </div>
                <div className="flex items-center gap-2 text-[10px] font-black text-foreground/80">
                  <CheckCircle size={10} className="text-gradient-gold" /> Bebida de cortesia em cada visita
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/5 p-6 rounded-[32px] border border-white/20 shadow-2xl backdrop-blur-lg relative overflow-hidden ring-1 ring-white/10 group">
              ...
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-[9px] font-black text-muted-foreground uppercase tracking-widest">500+ Pontos ou Assinatura</p>
                </div>
              </div>
